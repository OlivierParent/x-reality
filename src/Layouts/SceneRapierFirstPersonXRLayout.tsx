...
/**
 * Layout for a scene with Rapier physics engine for First Person view with XR enabled.
 *
 * @param {LayoutProps} props
 * @returns {React.JSX.Element}
 */
const SceneRapierFirstPersonXRLayout = ({
  children,
...
export { SceneRapierFirstPersonXRLayout as Layout };
